---
title: Teleport
description: Lean how teleport works and how to use it in Vue.
...
---
    ...
    `<Teleport>` is a built-in component that allows us to move a part of a component's template into a DOM node that exists outside the DOM hierarchy of that component.
  ...
  You can combine `<Teleport>` with `<Transition>` to create animated modals - see <a href="https://vuejs.org/examples/#modal" class="addcolortext"> Example here</a>.
  ...
  ### Deferred Teleport <span class="float"> 3.5+</span>
