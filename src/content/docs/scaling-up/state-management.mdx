...
description: Learn about state management in Vue js
...
---
  ...
  ![One way data flow in Vue](https://vuejs.org/assets/state-flow.Cd6No79V.png)
  ...
  <a href="https://pinia.vuejs.org/" class="addcolortext"> Pinia </a> is a state management library that implements all of the above. It is maintained by the Vue core team, and works with both Vue 2 and Vue 3.

  Existing users may be familiar with <a href="https://vuex.vuejs.org/" class="addcolortext"> Vuex </a>, the previous official state management library for Vue. With Pinia serving the same role in the ecosystem, Vuex is now in maintenance mode. It still works, but will no longer receive new features. It is recommended to use Pinia for new applications.
