...
import { Card, CardGrid } from '@astrojs/starlight/components';
  ...
  <img src="https://vuejs.org/assets/components.B1JZbf0_.png"/>
  ...
  Here is  a simple example of Vue component:
  ``` vue
    // vue
    <template>
       <div>
  ...
  **Result**: 
  ...
  This simple welcome component can be reused several times across different files.
